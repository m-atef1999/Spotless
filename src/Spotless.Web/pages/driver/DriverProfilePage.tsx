...
export const DriverProfilePage: React.FC = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const data = await DriversService.getApiDriversProfile();
                setProfile(data);
    ...
    const onSubmit = async (data: DriverProfileFormValues) => {
        ...
        try {
            ...
            await DriversService.putApiDriversProfile({ requestBody: command });
            setSuccessMessage('Profile updated successfully!');

            // Refresh profile data
            const updatedProfile = await DriversService.getApiDriversProfile();

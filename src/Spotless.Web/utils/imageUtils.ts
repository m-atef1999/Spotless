export const getServiceImage = (serviceName: string): string => {
    ...
    if (name.includes('shirt')) return 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&q=80';
    ...
    if (name.includes('pants') || name.includes('trousers')) return 'https://images.unsplash.com/photo-1473966968600-fa801b869a1a?w=800&q=80';
    if (name.includes('jacket') || name.includes('coat')) return 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=800&q=80';
    if (name.includes('bed') || name.includes('sheet')) return 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=800&q=80';
    ...
    if (name.includes('dry')) return 'https://images.unsplash.com/photo-1489278530698-d4757abdff0f?w=800&q=80';
    if (name.includes('wash')) return 'https://images.unsplash.com/photo-1517677208171-0bc12dd9aaea?w=800&q=80';
    if (name.includes('iron')) return 'https://images.unsplash.com/photo-1582735689369-4fe89db7114c?w=800&q=80';

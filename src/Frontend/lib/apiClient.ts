...
export interface IClient {
     ...
     * @return Success
     */
    dashboard(pageNumber: number | undefined, pageSize: number | undefined, signal?: AbortSignal): Promise<AdminDashboardDto>;

    /**
     * @param body (optional) 
     * @return Success
     */
    login(body: LoginCommand | undefined, signal?: AbortSignal): Promise<AuthResult>;

    /**
     * @param body (optional) 
     * @return Success
     */
    refresh(body: RefreshTokenCommand | undefined, signal?: AbortSignal): Promise<AuthResult>;

    /**
     * @param body (optional) 
     * @return Success
     */
    changePassword(body: ChangePasswordCommand | undefined, signal?: AbortSignal): Promise<void>;
     ...
     * @return Success
     */
    send(body: SendVerificationEmailCommand | undefined, signal?: AbortSignal): Promise<void>;
     ...
     * @return Success
     */
    confirm(userId: string | undefined, token: string | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    sendOtp(body: SendOtpCommand | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    confirmOtp(body: VerifyOtpCommand | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    google(body: ExternalAuthRequest | undefined, signal?: AbortSignal): Promise<AuthResult>;

    /**
     * @return Success
     */
    cartGET(customerId: string, signal?: AbortSignal): Promise<void>;

    /**
     * @return Success
     */
    cartDELETE(customerId: string, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    itemsPOST(customerId: string, body: AddToCartDto | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @return Success
     */
    itemsDELETE(customerId: string, serviceId: string, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    checkout(customerId: string, body: CartCheckoutRequest | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    buynow(customerId: string, body: BuyNowRequest | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    register(body: RegisterCustomerCommand | undefined, signal?: AbortSignal): Promise<AuthResult>;
     ...
     * @return Success
     */
    dashboard2(pageNumber: number | undefined, pageSize: number | undefined, signal?: AbortSignal): Promise<CustomerDashboardDto>;

    /**
     * @return Success
     */
    profileGET(signal?: AbortSignal): Promise<CustomerDto>;

    /**
     * @param body (optional) 
     * @return No Content
     */
    profilePUT(body: UpdateCustomerDto | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    topup(body: TopUpWalletRequest | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Created
     */
    register2(body: SubmitDriverApplicationDto | undefined, signal?: AbortSignal): Promise<string>;

    /**
     * @return Success
     */
    profileGET2(signal?: AbortSignal): Promise<DriverDto>;

    /**
     * @param body (optional) 
     * @return No Content
     */
    profilePUT2(body: UpdateDriverProfileDto | undefined, signal?: AbortSignal): Promise<void>;
     ...
     * @return Success
     */
    available(signal?: AbortSignal): Promise<OrderDto[]>;

    /**
     * @param body (optional) 
     * @return No Content
     */
    status(body: DriverStatusUpdateDto | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return No Content
     */
    location(body: LocationDto | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @return Created
     */
    apply(orderId: string, signal?: AbortSignal): Promise<string>;

    /**
     * @param body (optional) 
     * @return Success
     */
    approve(applicationId: string, body: ApproveDriverRequest | undefined, signal?: AbortSignal): Promise<string>;

    /**
     * @return Success
     */
    orderApplications(orderId: string, signal?: AbortSignal): Promise<void>;

    /**
     * @return Success
     */
    accept(applicationId: string, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Success
     */
    assign(body: AssignDriverCommand | undefined, signal?: AbortSignal): Promise<void>;

    /**
     * @param body (optional) 
     * @return Created
     */
    ordersPOST(body: CreateOrderDto | undefined, signal?: AbortSignal): Promise<OrderDto>;

    /**
     * @return Success
     */
    ordersGET(id: string, signal?: AbortSignal): Promise<OrderDto>;
     ...
     * @return Success
     */
    customer(pageNumber: number | undefined, pageSize: number | undefined, signal?: AbortSignal): Promise<OrderDtoPagedResponse>;

    /**
     * @return Success
     */
    cancel(id: string, signal?: AbortSignal): Promise<OrderDto>;
     ...
     * @return Success
     */
    webhook(hmac_SHA512: string | undefined, body: PaymobProcessedCallbackData | undefined, signal?: AbortSignal): Promise<void>;
     ...
     * @return Created
     */
    reviews(body: CreateReviewDto | undefined, signal?: AbortSignal): Promise<string>;

    /**
     * @return Success
     */
    driver(driverId: string, signal?: AbortSignal): Promise<ReviewDto[]>;

    /**
     * @return Success
     */
    customerAll(signal?: AbortSignal): Promise<ReviewDto[]>;
     ...
     * @return Success
     */
    all(pageNumber: number | undefined, pageSize: number | undefined, signal?: AbortSignal): Promise<ReviewDtoPagedResponse>;
     ...
     * @return Success
     */
    services(nameSearchTerm: string | undefined, pageNumber: number | undefined, pageSize: number | undefined, signal?: AbortSignal): Promise<ServiceDtoPagedResponse>;

    /**
     * @return Success
     */
    services2(id: string, signal?: AbortSignal): Promise<ServiceDto>;

    /**
     * @param count (optional) 
     * @return Success
     */
    featured(count: number | undefined, signal?: AbortSignal): Promise<ServiceDto[]>;
}
...
export class Client implements IClient {
     ...
     */
    itemsPOST(customerId: string, body: AddToCartDto | undefined, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/api/Cart/{customerId}/items";
        if (customerId === undefined || customerId === null)
            throw new globalThis.Error("The parameter 'customerId' must be defined.");
        url_ = url_.replace("{customerId}", encodeURIComponent("" + customerId));
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    itemsDELETE(customerId: string, serviceId: string, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/api/Cart/{customerId}/items/{serviceId}";
        if (customerId === undefined || customerId === null)
            throw new globalThis.Error("The parameter 'customerId' must be defined.");
        url_ = url_.replace("{customerId}", encodeURIComponent("" + customerId));
     ...
     */
    checkout(customerId: string, body: CartCheckoutRequest | undefined, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/api/Cart/{customerId}/checkout";
        if (customerId === undefined || customerId === null)
            throw new globalThis.Error("The parameter 'customerId' must be defined.");
        url_ = url_.replace("{customerId}", encodeURIComponent("" + customerId));
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    buynow(customerId: string, body: BuyNowRequest | undefined, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/api/Cart/{customerId}/buynow";
        if (customerId === undefined || customerId === null)
            throw new globalThis.Error("The parameter 'customerId' must be defined.");
        url_ = url_.replace("{customerId}", encodeURIComponent("" + customerId));
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    dashboard2(pageNumber: number | undefined, pageSize: number | undefined, signal?: AbortSignal): Promise<CustomerDashboardDto> {
        let url_ = this.baseUrl + "/api/Customer/dashboard?";
        if (pageNumber === null)
            throw new globalThis.Error("The parameter 'pageNumber' cannot be null.");
        else if (pageNumber !== undefined)
            url_ += "pageNumber=" + encodeURIComponent("" + pageNumber) + "&";
     ...
     */
    profileGET(signal?: AbortSignal): Promise<CustomerDto> {
        let url_ = this.baseUrl + "/api/Customer/profile";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processProfileGET(response: Response): Promise<CustomerDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
     ...
     */
    topup(body: TopUpWalletRequest | undefined, signal?: AbortSignal): Promise<void> {
        let url_ = this.baseUrl + "/api/Customer/topup";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processProfileGET2(response: Response): Promise<DriverDto> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 200) {
            return response.text().then((_responseText) => {
    ...
    profilePUT2(body: UpdateDriverProfileDto | undefined, signal?: AbortSignal): Promise<void> {
        ...
        return this.http.fetch(url_, options_).then((_response: Response) => {
            return this.processProfilePUT2(_response);
        });
    }

    protected processProfilePUT2(response: Response): Promise<void> {
        const status = response.status;
        let _headers: any = {}; if (response.headers && response.headers.forEach) { response.headers.forEach((v: any, k: any) => _headers[k] = v); };
        if (status === 204) {
            return response.text().then((_responseText) => {
...
export class SubmitDriverApplicationDto implements ISubmitDriverApplicationDto {
    email?: string | undefined;
    name?: string | undefined;
    phone?: string | undefined;
    vehicleInfo?: string | undefined;

    constructor(data?: ISubmitDriverApplicationDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): SubmitDriverApplicationDto {
        data = typeof data === 'object' ? data : {};
        let result = new SubmitDriverApplicationDto();
        result.init(data);
        return result;
    }
...
export interface ISubmitDriverApplicationDto {
    email?: string | undefined;
    name?: string | undefined;
    phone?: string | undefined;
    vehicleInfo?: string | undefined;
...
export class TopUpWalletRequest implements ITopUpWalletRequest {
    amountValue?: number;
    paymentMethod?: PaymentMethod;

    constructor(data?: ITopUpWalletRequest) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): TopUpWalletRequest {
        data = typeof data === 'object' ? data : {};
        let result = new TopUpWalletRequest();
        result.init(data);
        return result;
    }
...
export class UpdateDriverProfileDto implements IUpdateDriverProfileDto {
    name?: string | undefined;
    phone?: string | undefined;
    vehicleInfo?: string | undefined;

    constructor(data?: IUpdateDriverProfileDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): UpdateDriverProfileDto {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateDriverProfileDto();
        result.init(data);
        return result;
    }
...
export interface IUpdateDriverProfileDto {
    name?: string | undefined;
    phone?: string | undefined;
    vehicleInfo?: string | undefined;
}
